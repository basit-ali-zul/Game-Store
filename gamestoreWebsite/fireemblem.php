...
<head>
  ...
  <title>Fire Emblem | Download</title>
...
<div class="outter-container">
    <div class="big-box">
        <div class="left-box">
            <img style="float: left;" class="game-img" src="https://www.bhphotovideo.com/images/images1500x1500/nintendo_hacpanvya_fire_emblem_three_houses_1470935.jpg">
        </div>
        <div class="right-box">
            <h1 class="title">Fire Emblem</h1>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Price: 
                    <h3  style="float: right;color:black;">Rs. 1899</h3>
                </h3>
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Developer:
                    <h3  style="float: right;color:black;"> Intelligent Systems </h3>
                </h3> 
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Publisher: 
                    <h3 style="float: right;color:black;"> Nintendo</h3>
                </h3>
            </div>
            ...
            if(array_key_exists('purchasebtn', $_POST)) {
                makePurchase($user_data['userid'],$gameid,'fireemblem.php');
            }
