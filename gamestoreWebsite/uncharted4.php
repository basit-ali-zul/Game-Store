...
<head>
  ...
  <title>Uncharted 4 | Download</title>
...
<div class="outter-container">
    <div class="big-box">
        <div class="left-box">
            <img style="float: left;" class="game-img" src="https://cdn.the-new-englander.com/wp-content-wasabi/2018/11/Uncharted-4.jpg">
        </div>
        <div class="right-box">
            <h1 class="title">Uncharted 4</h1>
            ...
            <div class="game-detail" >
                <h3 style="color:#555">
                    Developer:
                    <h3  style="float: right;color:black;"> Naughty Dog </h3>
                </h3> 
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
            ...
            if(array_key_exists('purchasebtn', $_POST)) {
                makePurchase($user_data['userid'],$gameid,'uncharted4.php');
            }
