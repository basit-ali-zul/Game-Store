...
<head>
  ...
  <title>Astral Chain | Download</title>
...
<div class="outter-container">
    <div class="big-box">
        <div class="left-box">
            <img style="float: left;" class="game-img" src="https://gamingbolt.com/wp-content/uploads/2019/07/astral-chain-image-2.jpg">
        </div>
        <div class="right-box">
            <h1 class="title">Astral Chain</h1>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Price: 
                    <h3  style="float: right;color:black;">Rs. 2299</h3>
                </h3>
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Developer:
                    <h3  style="float: right;color:black;"> Platinum Games </h3>
                </h3> 
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
            ...
            if(array_key_exists('purchasebtn', $_POST)) {
                makePurchase($user_data['userid'],$gameid,'astralchain.php');
            }
