...
<head>
  ...
  <title>Super Mario Odessy | Download</title>
...
<div class="outter-container">
    <div class="big-box">
        <div class="left-box">
            <img style="float: left;" class="game-img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_Z0WJyKrkMF_elHAcoW_2LuuV1zUo7yPR6w&usqp=CAU">
        </div>
        <div class="right-box">
            <h1 class="title">Super Mario Odessy</h1>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Price: 
                    <h3  style="float: right;color:black;">Rs. 1999</h3>
                </h3>
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Developer:
                    <h3  style="float: right;color:black;"> Nintendo SPD </h3>
                </h3> 
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
            ...
            if(array_key_exists('purchasebtn', $_POST)) {
                makePurchase($user_data['userid'],$gameid,'supermario.php');
            }
