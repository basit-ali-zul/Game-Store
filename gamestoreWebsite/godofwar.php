...
<head>
  ...
  <title>God Of War | Download</title>
...
<div class="outter-container">
    <div class="big-box">
        <div class="left-box">
            <img style="float: left;" class="game-img" src="https://image.api.playstation.com/vulcan/img/rnd/202011/1021/X3WIAh63yKhRRiMohLoJMeQu.png">
        </div>
        <div class="right-box">
            ...
            <div class="game-detail" >
                <h3 style="color:#555">
                    Price: 
                    <h3  style="float: right;color:black;">Rs. 2999</h3>
                </h3>
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Developer:
                    <h3  style="float: right;color:black;"> Santa Monica Studio</h3>
                </h3> 
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Publisher: 
                    <h3 style="float: right;color:black;"> PlayStation PC LLC</h3>
                </h3>
            </div>
            ...
            if(array_key_exists('purchasebtn', $_POST)) {
                makePurchase($user_data['userid'],$gameid,'godofwar.php');
            }
