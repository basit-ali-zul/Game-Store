...
<head>
  ...
  <title>Mortal Kombat 10 | Download</title>
...
<div class="outter-container">
    <div class="big-box">
        <div class="left-box">
            <img style="float: left;" class="game-img" src="https://rukminim1.flixcart.com/image/612/612/jtx9evk0/physical-game/j/k/e/standard-edition-mortal-kombat-11-full-game-xbox-one-original-imaff5x5eyz5d9cb.jpeg?q=70"">
        </div>
        <div class="right-box">
            <h1 class="title">Mortal Kombat 10</h1>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Price: 
                    <h3  style="float: right;color:black;">Rs. 3999</h3>
                </h3>
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Developer:
                    <h3  style="float: right;color:black;"> Nehter Realm Studios </h3>
                </h3> 
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Publisher: 
                    <h3 style="float: right;color:black;"> Mid Way Games</h3>
                </h3>
            </div>
            ...
            if(array_key_exists('purchasebtn', $_POST)) {
                makePurchase($user_data['userid'],$gameid,'mortalkombat10.php');
            }
