...
<head>
  ...
  <title>Legend of Zelda  | Download</title>
...
<div class="outter-container">
    <div class="big-box">
        <div class="left-box">
            <img style="float: left;" class="game-img" src="https://assets-prd.ignimgs.com/2022/06/14/zelda-breath-of-the-wild-1655249167687.jpg">
        </div>
        <div class="right-box">
            <h1 class="title">Legend of Zelda</h1>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Price: 
                    <h3  style="float: right;color:black;">Rs. 2499</h3>
                </h3>
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
            ...
            if(array_key_exists('purchasebtn', $_POST)) {
                makePurchase($user_data['userid'],$gameid,'legendofzelda.php');
            }
