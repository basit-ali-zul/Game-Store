...
<head>
  ...
  <title>Devil May Cry 5 | Download</title>
...
<div class="outter-container">
    <div class="big-box">
        <div class="left-box">
            <img style="float: left;" class="game-img" src="https://images-na.ssl-images-amazon.com/images/I/81WV0wiR2gL._AC_SL1500_.jpg">
        </div>
        <div class="right-box">
            <h1 class="title">Devil May Cry 5</h1>
            ...
            if(array_key_exists('purchasebtn', $_POST)) {
                makePurchase($user_data['userid'],$gameid,'devilmaycry5.php');
            }
