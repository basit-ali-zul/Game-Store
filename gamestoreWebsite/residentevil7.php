...
<head>
  ...
  <title>Resident Evil 7 | Download</title>
...
<div class="outter-container">
    <div class="big-box">
        <div class="left-box">
            <img style="float: left;" class="game-img" src="https://images-na.ssl-images-amazon.com/images/I/91ax40t%2B4DL._SL1500_.jpg">
        </div>
        <div class="right-box">
            <h1 class="title">Resident Evil 7</h1>
            ...
            <div class="game-detail" >
                <h3 style="color:#555">
                    Developer:
                    <h3  style="float: right;color:black;"> Koei Techmo </h3>
                </h3> 
            </div>
            <div class="game-detail" >
                <h3 style="color:#555">
                    Publisher: 
                    <h3 style="float: right;color:black;"> Capcom</h3>
                </h3>
            </div>
            ...
            if(array_key_exists('purchasebtn', $_POST)) {
                makePurchase($user_data['userid'],$gameid,'residentevil.php');
            }
